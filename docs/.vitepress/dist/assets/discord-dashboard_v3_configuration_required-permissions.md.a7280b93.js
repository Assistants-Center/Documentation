...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,5);function D(E,y,d,_,S,N){const n=c("Badge");return A(),e("div",null,[l("h1",i,[s("Required Permissions "),a(n,{type:"info",text:"OPTIONAL"}),s(),a(n,{type:"tip",text:"DEFAULT ADMINISTRATOR"}),s(),t]),C])}const M=p(r,[["render",D]]);export{I as __pageData,M as default};
